...
import { Email } from "../utils/emailFeature.js";
...
const signUp = catchAsync(async (req, res, next) => {
  console.log(req.body, "from authController", req.protocol);
...
// Role protection middleware is verified token and user existence
